...
import ListElementRenderFour from '../Components/listElementComponentFour';
import Element from '../Models/CoucheClass'
import { Ionicons } from '@expo/vector-icons';

const CoucheFourScreen = function coucheFourScreen({navigation,route}){
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scroll}>
                <View style={styles.listRender}>
                    <ListElementRenderFour navigation={navigation} couche={couche}  idPreviousCategory={idPreviousCategory}/> 
                </View>
          </ScrollView>
        </View>
...
const styles = StyleSheet.create({
  ...
  export default CoucheFourScreen;